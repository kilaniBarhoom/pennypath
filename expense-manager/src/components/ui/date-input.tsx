...
const DateInput: React.FC<DateInputProps> = ({ value, onChange }) => {
  ...
  return (
    <div className="flex border rounded-sm items-center text-sm px-1">
      <input
        type="text"
        ref={monthRef}
        max={12}
        ...
        className="p-0 outline-none w-6 bg-background border-none text-center"
        placeholder="M"
      />
      ...
      <input
        ...
        className="p-0 outline-none w-7 bg-background border-none text-center"
        placeholder="D"
      />
      <span className="opacity-20 -mx-px">/</span>
      <input
        ...
        className="p-0 outline-none w-12 bg-background border-none text-center"
        placeholder="YYYY"
      />
    </div>
  );
