  ...
  return (
    <PopoverPrimitive.Trigger ref={forwardedRef as any} asChild>
      <div
        ...
        {...props}
        className={ny(
          "border-input ring-offset-background focus:ring-ring flex size-full min-h-10 items-center justify-between whitespace-nowrap rounded-sm border bg-transparent px-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-1 [&>span]:line-clamp-1",
  ...
  return (
    <PopoverPrimitive.Portal forceMount>
      <PopoverPrimitive.Content
        ...
        collisionPadding={10}
        className={ny(
          "bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 w-full rounded-sm border p-0 shadow-md outline-none"
        )}
        style={
          {
