...
import AddEditPayment from "../components/payments/add-edit-sheet-drawer";
...
const Payments = () => {
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="w-full flex items-center justify-between gap-2 flex-wrap mb-4">
        <BreadcrumbComponent
          tree={[
            {
              title: "Payments",
